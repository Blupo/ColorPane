...
local DocumentationPluginMenu = require(Modules.DocumentationPluginMenu)
        ...
        listElements[compositeName] = Roact.createElement(ColorPropertyListItem, {
            ...
            promptForEdit = function()
                if (isColorSequence) then
                    if (not ColorPane.IsGradientPromptAvailable()) then return end
                else
                    if (not ColorPane.IsColorPromptAvailable()) then return end
                end
                ...
                editColorPromise:andThen(function(newColor)
                    ...
                    if (err == ColorPane.PromptRejection.PromptCancelled) then
